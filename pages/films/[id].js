...
export default function Movie({ movie, movieReviews: initiation }) {
  const [movieReviews, setMovieReviews] = useState(initiation);
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMovieReviews([...movieReviews, nextMovieReview]);
    } catch (error) {}
  }
